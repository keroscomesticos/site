...
2. Descompacte o ZIP. Dentro dele há a pasta `dist-github/`, que contém todos os arquivos do site (`index.html`, `404.html`, `content-gh.json`, pastas `assets/` e `images/`), além deste guia.
...
5. Abra a pasta `dist-github/` do seu computador e arraste **todo o conteúdo dela** para a área de upload do GitHub e clique em **Commit changes**.
